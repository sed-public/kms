...
/// Warning: Any change to this struct (size, hashing function, ...) will break the compatibility with existing indexes
/// and should be considered as a breaking change.
